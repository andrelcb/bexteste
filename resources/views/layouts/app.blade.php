...
@section('body')
    ...
    <div class="flex flex-col  justify-start  min-h-screen py-12 bg-gray-100 sm:px-6 lg:px-8">
        ...
        <x-card class="w-full">
            <ul class="flex text-center justify-center text-lg">
                <li class="mr-6">
                ...
                <li class="mr-6">
                    <a class=" @if(Route::currentRouteName() == 'vendas') text-blue-500 hover:text-blue-800 @endif text-gray-500 focus:border-gray-800 hover:text-gray-800"
                       href="{{route('vendas')}}">Vendas</a>
                </li>
                <li class="mr-6">
